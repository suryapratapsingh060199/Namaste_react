...
const RestaurantCard = ({resData}) => {
    ...
    return(
    <div data-testid="resCard" className="m-2 p-2 w-[300px] h-auto text-center bg-gray-100 hover:bg-gray-300 rounded-lg">
        ...
        <div className="py-2 m-2 text-xl">User: {loggedInUser}</div>
    </div>
);
}
